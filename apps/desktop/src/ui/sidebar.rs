                    ...
                    ui.horizontal(|ui| {
                        ...
                        if ui.button("Open").clicked() {
                            if !self.workspace_path_input.is_empty() {
                                match app.open_workspace(self.workspace_path_input.clone()) {
                                    Ok(_) => {
                                        self.open_workspace_dialog = false;
                                        self.workspace_path_input.clear();
                                    }
                        ...
                        if ui.button("Create").clicked() {
                            if !self.create_file_path_input.is_empty() {
                                let full_path = if !app.workspace_path.is_empty() {
                                    format!("{}/{}", app.workspace_path, self.create_file_path_input)
                                } else {
                                    self.create_file_path_input.clone()
                                };
                    ...
                    ui.horizontal(|ui| {
                        ...
                        if ui.button("Delete").clicked() {
                            if !self.delete_file_path_input.is_empty() {
                                let full_path = if !app.workspace_path.is_empty() {
                                    format!("{}/{}", app.workspace_path, self.delete_file_path_input)
                                } else {
                                    self.delete_file_path_input.clone()
                                };
                    ...
                    ui.horizontal(|ui| {
                        ...
                        if ui.button("Open").clicked() {
                            if !self.open_file_path_input.is_empty() {
                                let full_path = if !app.workspace_path.is_empty() {
                                    format!("{}/{}", app.workspace_path, self.open_file_path_input)
                                } else {
                                    self.open_file_path_input.clone()
                                };
