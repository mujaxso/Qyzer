...
// Or create a new file using the command palette (Ctrl+P)`);
  ...
  return (
    <div className="h-full flex flex-col bg-editor">
      <div className="border-b border-divider px-3 py-1.5 flex items-center justify-between bg-panel">
        <div className="flex items-center space-x-3">
          ...
          {activeFilePath && (
            <span className="text-xs text-primary/80 font-mono truncate max-w-xl leading-none" title={activeFilePath}>
              {activeFilePath}
            </span>
          )}
        </div>
